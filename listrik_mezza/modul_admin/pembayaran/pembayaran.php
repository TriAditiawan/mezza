...
<div id="konten">
  ...
  <form method="POST" action="media_admin.php?module=register_pembayaran" align="center"
    onsubmit="return validasi(this)">
    <table cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td width="20%">id_bayar</td>
        <td>:</td>
        <td>
          <input type="text" name="input_id_bayar" size="40%">
        </td>
      </tr>
      <tr>
        <td width="20%">id tagihan</td>
        <td>:</td>
        <td>
          <select name="input_id_tagihan" style="width: 60%;">
            ...
            <?php
					...
					?>
            <option value=<?php echo $dataForeign['id_tagihan']?>> <?php echo $dataForeign['id_tagihan']?>
            </option>
            <?php
						}
					?>
      ...
      <tr>
        ...
        <td>:</td>
        <td>
          <input type="date" name="input_tanggal" size="40%">
        </td>
      </tr>
      <tr>
        ...
        <td>:</td>
        <td>
          <input type="text" name="input_bulan_bayar" size="40%">
        </td>
      </tr>
      <tr>
        ...
        <td>:</td>
        <td>
          <input type="text" name="input_badmin" size="40%">
        </td>
      </tr>
      <tr>
        <td></td>
