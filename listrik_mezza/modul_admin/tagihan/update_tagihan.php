<?php
	include "koneksi.php";
	$kode= $_GET['kode'];
	$queryEdit = mysqli_query($connection,"SELECT * FROM tbl_tagihan where id_tagihan='$kode' limit 1")or die(mysqli_error());
	$dataEdit = mysqli_fetch_array($queryEdit);
?>
<div id="konten">
  <h1>Data tagihan</h1>
  <form method="POST"
    action="media_admin.php?module=update_proses_tagihan&amp;kode=<?php echo $dataEdit['id_tagihan'];?>" align="center"
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <tr>
        ...
        <td>:</td>
        <td>
          <input type="text" name="input_id_tagihan" size="40%" value=<?php echo $dataEdit['id_tagihan'];?>>
        </td>
      </tr>
      <tr>
        ...
        <td>:</td>
        <td>
          <select name="input_id_penggunaan" style="width: 70%;">
            ...
            <?php
					...
					?>
            <option value=<?php echo $dataForeign['id_penggunaan']; ?> <?php 
							if($dataEdit['id_penggunaan'] == $dataForeign['id_penggunaan']){
								echo "selected";
							} 
						?>>
              <?php echo $dataForeign['id_penggunaan'];?>
            </option>
            <?php
						}
					?>
      ...
      <tr>
        ...
        <td>:</td>
        <td>
          <input type="text" name="input_bulan" size="40%" value=<?php echo $dataEdit['bulan'];?>>
        </td>
      </tr>
      <tr>
        ...
        <td>:</td>
        <td>
          <input type="text" name="input_tahun" size="40%" value=<?php echo $dataEdit['tahun'];?>>
        </td>
      </tr>
      <tr>
        <td width="20%">jumlah meter</td>
        <td>:</td>
        <td>
          <input type="text" name="input_jumlah_meter" size="40%" value=<?php echo $dataEdit['jumlah_meter'];?>>
        </td>
      </tr>
      <tr>
        ...
        <td>:</td>
        <td>
          <input type="text" name="input_status" size="40%" value=<?php echo $dataEdit['status'];?>>
        </td>
      </tr>
      <tr>
        <td></td>
        <td></td>
        <td><input type="submit" name="update tagihan" value="Update">
